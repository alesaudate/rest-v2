package app.car.cap06;

import app.car.cap06.domain.User;
...
public class Cap06Application {

	public static void main(String[] args) {
		ConfigurableApplicationContext ctx = SpringApplication.run(Cap06Application.class, args);
